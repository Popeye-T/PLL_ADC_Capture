...
module system
   (AD9516_SPI_tri_i,
    ...
    FIXED_IO_ps_porb,
    FIXED_IO_ps_srstb);
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 AD9516_SPI TRI_I" *) input [3:0]AD9516_SPI_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 AD9516_SPI TRI_O" *) output [3:0]AD9516_SPI_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 AD9516_SPI TRI_T" *) output [3:0]AD9516_SPI_tri_t;
  ...
  assign AD9516_SPI_tri_o[3:0] = processing_system7_0_GPIO_0_TRI_O;
  assign AD9516_SPI_tri_t[3:0] = processing_system7_0_GPIO_0_TRI_T;
  assign processing_system7_0_GPIO_0_TRI_I = AD9516_SPI_tri_i[3:0];
