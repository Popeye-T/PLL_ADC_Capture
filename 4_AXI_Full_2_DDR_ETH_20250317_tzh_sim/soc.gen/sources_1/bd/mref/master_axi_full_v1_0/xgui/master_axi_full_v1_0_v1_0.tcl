...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BURST_TIMES" -parent ${Page_0}
...
proc update_PARAM_VALUE.BURST_TIMES { PARAM_VALUE.BURST_TIMES } {
	# Procedure called to update BURST_TIMES when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BURST_TIMES { PARAM_VALUE.BURST_TIMES } {
	# Procedure called to validate BURST_TIMES
	return true
}
...
proc update_MODELPARAM_VALUE.BURST_TIMES { MODELPARAM_VALUE.BURST_TIMES PARAM_VALUE.BURST_TIMES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BURST_TIMES}] ${MODELPARAM_VALUE.BURST_TIMES}
}
