...
--               d:/workspace/ADC_Cap/3_AXI_Full_2_DDR_ETH/soc.gen/sources_1/bd/system/ip/system_master_axi_full_v1_0_0_0/system_master_axi_full_v1_0_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of system_master_axi_full_v1_0_0_0_master_axi_full_v1_0 is
  ...
  signal \write_burst_counter[10]_i_5_n_0\ : STD_LOGIC;
  signal \write_burst_counter[10]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \axi_awaddr_reg[26]_i_3\ : label is 11;
  ...
  attribute SOFT_HLUTNM of \read_burst_counter[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \read_burst_counter[1]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \read_burst_counter[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \read_burst_counter[8]_i_2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \read_index[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \read_index[7]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of reads_done_i_2 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \write_burst_counter[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \write_burst_counter[1]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \write_burst_counter[6]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \write_burst_counter[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \write_burst_counter[8]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \write_index[4]_i_1\ : label is "soft_lutpair6";
...
\read_burst_counter[10]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\read_burst_counter[10]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\read_burst_counter[10]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\read_burst_counter[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DF20"
    )
        port map (
...
\read_burst_counter[8]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\read_index[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EF000000"
    )
        port map (
...
\write_burst_counter[10]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\write_burst_counter[10]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFFFFFFFFFF"
    )
        port map (
...
\write_burst_counter[10]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\write_burst_counter[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7FF0800"
    )
        port map (
...
\write_burst_counter[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F7FFFFFF08000000"
    )
        port map (
...
\write_burst_counter[8]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
architecture STRUCTURE of system_master_axi_full_v1_0_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of M_AXI_ACLK : signal is "XIL_INTERFACENAME M_AXI_ACLK, ASSOCIATED_BUSIF M_AXI, ASSOCIATED_RESET M_AXI_ARESETN, FREQ_HZ 5e+07, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
